                ...
                <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)] transition-all">
                    ...
                    <p className="text-gray-400 mb-4">A responsive weather application that provides real-time weather information based on user-selected locations.
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <a href="https://jadenm628.github.io/Weather_Dashboard/" target="_blank" rel="noopener noreferrer" className="text-rose-400  hover:text-rose-300 transition-colors my-4">Live Demo →</a>
                        </div>
                    </p>
                </div>
